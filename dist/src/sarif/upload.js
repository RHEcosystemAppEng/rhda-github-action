...
export async function uploadSarifFile(ghToken, sarifPath, analysisStartTime, sha, ref, uploadToRepo, printSecurityTabLink) {
...
async function waitForUploadToFinish(ghToken, sarifId) {
