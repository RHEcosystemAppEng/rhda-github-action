...
class DockerImageAnalysis {
    ...
    collectImages(lines) {
        return lines.reduce((images, line) => {
 ...
 */
async function executeDockerImageAnalysis(filePath) {
...
export { executeDockerImageAnalysis };
