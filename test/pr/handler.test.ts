...
describe('isPr', () => {
    ...
    it('should return undefined if the event is not a pull request', async () => {
        ...
        expect(ghCore.info).toHaveBeenCalledWith('No checkout required, item is not a pull request');
    });
    ...
    it('should return parsed PR data if the event is a pull request', async () => {
      ...
      it('should throw error when base repo owner does not exist', async () => {
        ...
        expect(isPr()).rejects.toThrow(`Could not determine owner of pull request base repository`);
      });
      ...
      it('should throw error when head repo owner does not exist', async () => {
        ...
        expect(isPr()).rejects.toThrow(`Could not determine owner of pull request head repository`);
      });
});
